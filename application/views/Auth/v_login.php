        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" method="post" action="<?= base_url() ?>/auth/process">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="login" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Log In</button>
                                    </div>
                                </div>
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        <div class="checkbox-fade fade-in-primary d-">
                                            <label>
                                                <span class="text-inverse">Belum punya akun?</span>
                                            </label>
                                        </div>
                                        <div class="forgot-phone text-right f-right">
                                            <a href="<?= base_url() ?>auth/registrasi" class="btn btn-sm btn-outline-primary text-right f-w-600">Daftar</a>
                                        </div>
                                    </div>
                                </div>
                                <hr />
